...
function MedicalInfoSection({ control, setValue, watch }: SectionProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
      <div className="px-4 sm:px-0">
        <h2 className="text-base/7 font-semibold text-zinc-900">Medical Information</h2>
        <p className="mt-1 text-sm/6 text-zinc-600">
            ...
            <div className="col-span-full">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-indigo-500 text-xs">*Required</span>
                </div>
                ...
                {medicalDocumentPath ? (
                  <div className="mt-2 flex items-center gap-4">
                    ...
                    <button
                      type="button"
                      className="flex items-center gap-1 rounded-md bg-indigo-50 px-2 py-1 text-sm font-semibold text-indigo-600 hover:bg-indigo-100"
