...
export const HELP_GUIDES: HelpGuide[] = [
  ...
  },
  {
    ...
    platforms: BOTH_APPS,
    prerequisites: ["Have an API key from the service you want to connect."],
    steps: [
      "Open Settings.",
      "Choose the OpenRouter or ElevenLabs connection.",
      "Enter the service key.",
      "Save the connection and wait for its check.",
    ],
    expectedResult: "September marks the service as connected and enables its available features.",
    recovery: "If the check fails, copy a current key from the service account and reconnect it.",
...

  {
    ...
    related: ["restore-the-microphone-or-camera", "show-words-through-september-camera"],
    media: [
      {
        type: "video",
  ...
  {
    slug: "show-words-through-september-camera",
    category: "use-september-on-a-mac",
    title: "Show words through September Camera",
    summary: "Overlay the current Talk text on your camera feed in a calling app.",
    keywords: ["captions", "virtual camera", "overlay", "video call", "FaceTime", "Zoom"],
    platforms: ["mac-app"],
    prerequisites: ["Use the September Mac app on a supported Mac."],
    steps: [
      "Open Talk and open the audio selector beside Speak.",
      "Install September Camera when September offers it.",
      "Allow camera access.",
      "Choose September Camera in the calling app.",
      "Write in the Talk composer.",
    ],
    expectedResult: "The camera feed shows the current composer text over the picture.",
    recovery: "If September Camera is missing, reopen the selector, check its installation state, and restart the calling app.",
    related: ["speak-into-facetime-or-zoom", "restore-the-microphone-or-camera"],
  },
  {
  ...
  },
  {
    ...
    platforms: BOTH_APPS,
    prerequisites: ["Have a current key from the service account."],
    steps: [
      "Open Settings.",
      "Open the connection that is failing.",
      "Replace the saved key with a current key.",
      "Save it and wait for the connection check.",
  ...
  {
    slug: "restore-the-microphone-or-camera",
    category: "fix-a-problem",
    title: "Restore the microphone or camera",
    summary: "Make a September call device available to another Mac app again.",
    keywords: ["virtual device", "FaceTime", "Zoom", "input", "extension", "call"],
    platforms: ["mac-app"],
    prerequisites: ["Keep the September Mac app open."],
    steps: [
      "Open the Talk audio selector and check the September device state.",
      "Complete any installation or permission action shown there.",
      "Quit and reopen the calling app.",
      "Choose September Microphone or September Camera again in that app.",
      "Send a short test message from Talk.",
    ],
    expectedResult: "The calling app receives September sound or the captioned camera feed.",
    recovery: "If the device remains absent, restart September and the calling app after confirming the Mac permission.",
    related: ["speak-into-facetime-or-zoom", "show-words-through-september-camera"],
  },
  {
