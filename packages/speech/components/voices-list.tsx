            ...
            <div className="flex items-center gap-x-4 min-w-0 flex-1">
              {voice.preview_url && (
                <button
                  ...
                  className="flex items-center justify-center p-1.5 text-zinc-600 hover:text-zinc-900 hover:bg-zinc-50 rounded-md transition-colors"
                >
            ...
            <div className="flex flex-none items-center gap-x-4">
              {selectedVoiceId !== voice.id ? (
                <button
                  ...
                  className="shrink-0 px-3 py-2 text-sm font-semibold text-zinc-600 border border-zinc-200 hover:text-zinc-900 hover:bg-zinc-50 hover:border-zinc-300 rounded-md transition-colors"
                >
                  Use
                </button>
              ) : (
                <div className="px-3 py-2 shrink-0 text-indigo-600 text-sm font-semibold">
                  Selected
                </div>
              )}
            </div>
