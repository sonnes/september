        ...
        <div className="text-center">
          <div className="flex items-center justify-center mb-8">
            <a
              ...
              className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors border border-gray-200"
            >
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <div className="w-full p-3 rounded-xl border border-zinc-400 bg-white">
                    ...
                    <div className="w-0.5 h-5 bg-amber-600 inline-block ml-1 animate-blink align-middle"></div>
