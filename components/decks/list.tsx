...
const DecksList: React.FC = () => {
  ...
  return (
    <div className="mb-8 divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
      {decks.map((deck, idx) => {
          ...
          <Link href={`/read/${deck.id}`} key={deck.id}>
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">Deck ID: {deck.id}</p>
              </div>
              <span
                aria-hidden="true"
