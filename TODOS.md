...
- **Context:** See [apps/keyboard/docs/accessibility-implementation-guide.md](apps/keyboard/docs/accessibility-implementation-guide.md) for parallel Swift accessibility work — web flow should match conceptually. Switch Control test matrix should cover: auto-scan, single-switch, two-switch.
