...
| 2026-09-05 | Landing page hierarchy after visual critique | The hero shows a typed prefix, suggested words, and spoken result. The founder narrative sits in one text column before Talk, without a pull quote. Spaces and saved phrases share one composer beside the visible Agent customization demo. Notes and Voice use native disclosures. Marketing uses indigo with zinc neutrals, fewer frames, and soft shadows only on demo surfaces. Privacy becomes a text section before one indigo closing CTA. Noto, Lexend branding, the two-line tagline, and 44px targets remain. This supersedes the landing order, colour lanes, gradient hero, and section shadows in the 2026-08-24 entry. User-approved critique improvements. |
