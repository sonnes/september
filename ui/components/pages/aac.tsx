  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="flex items-center justify-between border-b px-4 py-3">
        <h1 className="text-2xl font-semibold">AAC Communication Board</h1>
      ...
      <main className="p-4">
        <div className="flex gap-4 mb-4">
          {/* Message Card - Takes up 2/3 of the space */}
          <Card className="flex-[2] overflow-hidden">
            <CardContent className="p-4">
              <div className="flex flex-col gap-4">
                <div
                  className="min-h-[100px] text-2xl font-medium leading-relaxed p-3 bg-primary/10 rounded-md"
                  aria-live="polite"
                >
          ...
          {/* Voice Recorder Card - Takes up 1/3 of the space */}
