 ...
 * words and a few more for the messages. Keep a snapshot in SQLite only if a
 * measurement shows that the start became slow.
 */
...
export function useSuggestions(
  ...
  return useMemo(
    () => suggestionsFor(theEngine(), draft, spaceId),
