...
import { Phrases } from "@/blocks/phrase-panel";
import { SpeechSettings } from "@/blocks/speech-settings";
import { currentPanel, rememberPanel } from "@/services/os";
import { PANEL_TABS, pressTab, type PanelTab } from "@/rules/panel";
