...
3. Server components validate session on each request
...
All routes under `/app/*` and `/api/*` are protected by authentication.
...
Domain packages use Supabase for data persistence:

- **Account Package** - [@september/account](../../packages/account/README.md)
- **Audio Package** - [@september/audio](../../packages/audio/README.md)
- **Chats Package** - [@september/chats](../../packages/chats/README.md)
...
- [Services Directory](../services/README.md) - External API integrations
- [API Routes](../app/api/README.md) - API endpoints using Supabase
