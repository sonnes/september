...
export const Route = createFileRoute('/_app/voices')({
  head: () => ({
    meta: [
      { title: pageTitle('Voices') },
      {
        name: 'description',
        content: 'Browse and find voices similar to your cloned voice.',
      },
    ],
  }),
  validateSearch: (s: Record<string, unknown>) => ({
    search: s.search === 'similar' ? ('similar' as const) : undefined,
  }),
...
function SimilarVoicesContent() {
  ...
  const isSimilarSearch = searchParam === 'similar';
