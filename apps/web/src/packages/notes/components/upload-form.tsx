  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="note-upload">Files</Label>
        <Input
          id="note-upload"
          type="file"
          multiple
          ...
          aria-describedby="note-upload-helper"
        />
        <p id="note-upload-helper" className="text-xs text-muted-foreground">
          We use Gemini to extract text from your uploads and append it to this note.
        </p>
      </div>
