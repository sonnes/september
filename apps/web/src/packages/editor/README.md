...
```ts
import { Editor, EditorProvider, TiptapEditor, useEditorContext } from '@/packages/editor';
...
| `TiptapEditor`       | Rich-text editor (ProseMirror / Tiptap) with Markdown support and formatting toolbar. Accepts `content`, `placeholder`, `onUpdate`, `className`; reports Markdown on edits and blur.                             |
